...
function ResWork() {
  ...
  const projects = [
    ...
    { thumbnail: "/projects/utah-brooklyn-loft/thumbnail.jpg", images: ["/projects/utah-brooklyn-loft/thumbnail.jpg", ...Array.from({ length: 10 }, (_, i) => `/projects/utah-brooklyn-loft/${String(i + 1).padStart(2, "0")}.jpg`)], title: "Brooklyn Loft", sub: "Open-plan loft · Custom kitchen · Polished concrete", tag: "Full Home" },
  ];
  return (
